<template>
    <div style="max-height:80vh;">
        <div class="gs-bundle-of-buttons" style="max-height:10vh;">
                ...
                <v-btn @click="createSalesOrderDialog = true" small color="primary" :disabled="!hasRole('SalePerson')">
                    <v-icon small>mdi-minus-circle-outline</v-icon>수주 생성
                </v-btn>
                <v-dialog v-model="createSalesOrderDialog" width="500">
                    <CreateSalesOrderCommand
                        @closeDialog="createSalesOrderDialog = false"
                        @createSalesOrder="createSalesOrder"
                    ></CreateSalesOrderCommand>
                </v-dialog>
                <v-btn @click="updateSalesOrderDialog = true" small color="primary" :disabled="!hasRole('SalePerson')">
                    <v-icon small>mdi-minus-circle-outline</v-icon>수주 수정
                </v-btn>
                <v-dialog v-model="updateSalesOrderDialog" width="500">
                    <UpdateSalesOrderCommand
                        @closeDialog="updateSalesOrderDialog = false"
